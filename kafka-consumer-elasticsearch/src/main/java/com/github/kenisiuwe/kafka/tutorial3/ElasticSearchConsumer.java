package com.github.kenisiuwe.kafka.tutorial3;
...
public class ElasticSearchConsumer {
    public static RestHighLevelClient createClient(){
        ...
        String hostname = "kafka-course-3756422210.us-east-1.bonsaisearch.net";
        String username = "kz8wdc62fm";
        String password = "zz59kvvvt1";
